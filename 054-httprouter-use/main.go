...
func index(w http.ResponseWriter, req *http.Request, _ httprouter.Params) {
	...
	var err error = tpl.ExecuteTemplate(w, "about.gohtml", nil)
	HandleError(w, err)
...
func contact(w http.ResponseWriter, req *http.Request, _ httprouter.Params) {
	var err error = tpl.ExecuteTemplate(w, "contact.gohtml", nil)
	HandleError(w, err)
}

func apply(w http.ResponseWriter, req *http.Request, _ httprouter.Params) {
	var err error = tpl.ExecuteTemplate(w, "apply.gohtml", nil)
	HandleError(w, err)
}

func applyProcess(w http.ResponseWriter, req *http.Request, _ httprouter.Params) {
	var err error = tpl.ExecuteTemplate(w, "applyProcess.gohtml", nil)
	HandleError(w, err)
}
